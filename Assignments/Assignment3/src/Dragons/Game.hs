...
import SushiGo (Player(..), otherPlayer, Outcome(..), Turn(..))
...
data MoveSource st mv f
  ...
  | AI String (GenericAI st mv) -- ^ A bot running on this computer
...
-- | An 'GenericAI' is how bots decide what move to make. Given a
